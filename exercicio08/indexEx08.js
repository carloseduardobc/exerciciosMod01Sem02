...
Relembrando: P.A. (Progressão Aritmética) é uma sequência numérica em que cada termo, a partir do segundo, é igual à soma do termo
anterior com a raiz. Exemplo: Valor inicial = 1; raiz = 3; P.A. = 1, 4, 7, 10, 13, 16, 19, 22, 25, 28.

Realize o commit do exercício resolvido.
*/

var valorInicial = parseInt(prompt('Informe o valor inicial: '));
var raiz = parseInt(prompt('Informe o valor de progressão: '));
